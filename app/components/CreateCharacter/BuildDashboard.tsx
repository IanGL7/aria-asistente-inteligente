...
const formSchema = z.object({
  ...
  title: z.string().min(2, "Minimo 2 caracteres").max(50, "Maximo 50 caracteres"),
  description: z.string().min(50, "Minimo 50 caracteres").max(200, "Maximo 200 caracteres"),
  prompt: z.string().min(100, "Minimo 100 caracteres").max(1000, "Maximo 1000 caracteres"),
  firstMessagePrompt: z.string().min(50, "Minimo 50 caracteres").max(150, "Maximo 150 caracteres"),
  voice: z.string().min(1, "Voice selection is required"),
  voiceCharacteristics: z.object({
    features: z.string().min(10, "Minimo 10 caracteres").max(150, "Maximo 150 caracteres"),
    emotion: z.string(),
...
const SettingsDashboard: React.FC<SettingsDashboardProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (personality) {
        toast({
          title: "Nuevo asistente Aria creado",
          description: "¡Tu asistente ha sido creado!",
          duration: 3000,
        });
        router.push(`/home`);
      }
      ...
      toast({
        title: "Error",
        description: "No se pudo crear tu asistente. Inténtalo de nuevo.",
        variant: "destructive",
        duration: 3000,
      });
    } finally {
      ...
      <form onSubmit={handleSubmit} className="space-y-6 mt-8 w-full pr-1">
        {currentStep === 'personality' ?
          <div className="space-y-4">
            {/* Voice Picker */}
            <div className="space-y-4">
              <Label htmlFor="voice">Elige una voz para Aria</Label>
<p className="text-sm text-gray-500">
  Haz clic en una voz para escuchar cómo sonará tu asistente.
</p>
  ...
  ¿Tienes ya una voz clonada en Hume o ElevenLabs?
</Label>
<p className="text-xs text-gray-500 mt-1">
  Puedes conectar una voz existente pegando el ID de tu agente de voz.
  Asegúrate siempre de contar con el consentimiento adecuado y de usar las voces de forma ética.
</p>
...
<Button
            ...
            <div className="space-y-2">
              <Label htmlFor="title">Nombre del asistente</Label>
              <Input
                id="title"
                placeholder="Ej. Aria Noche Segura"
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="description"
                placeholder="Resume en un parrafo corto para qué sirve este asistente Aria y a quién acompaña."
                rows={2}
            ...
            <div className="space-y-2">
              <Label htmlFor="prompt">Instrucciones detalladas para Aria</Label>
              <Textarea
                id="prompt"
                placeholder="Explica cómo debe hablar Aria, qué puede hacer y qué límites tiene. Ej.: tono calmado, dar recordatorios amables, nunca dar diagnósticos médicos, etc."
                rows={4}
            ...
            <div className="space-y-2">
              <Label htmlFor="firstMessagePrompt">Primer mensaje de Aria</Label>
              <Textarea
                id="firstMessagePrompt"
                placeholder="Mensaje de bienvenida que Aria enviará la primera vez que alguien hable con este asistente."
                rows={4}
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4 -pt-6 pb-4">
              <Label htmlFor="pitchFactor">Tono de la voz</Label>
              <p className="text-sm text-gray-500">
                Ajusta qué tan grave o aguda sonará Aria en tu dispositivo.
              </p>
            ...
            <div className="space-y-2">
              <Label htmlFor="voiceCharacteristics">Características de la voz</Label>
              <Textarea
                id="voiceCharacteristics"
                placeholder="Ej.: tono medio, ritmo lento, voz clara y cálida."
            ...
            <div className="space-y-4 pb-2">
              <Label className="block mb-2">Tono emocional</Label>
        ...
        {currentStep === 'personality' ? (
          ...
          >
            Caracteristicas de voz <ArrowRight className="w-4 h-4" />
          </Button>
        ) : (
